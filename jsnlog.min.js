...
function(a){try{var c=JSON.stringify({r:b.requestId,lg:a}),d=new XMLHttpRequest;d.open("POST",this.url);d.setRequestHeader("Content-Type","application/json");d.send(c)}catch(e){}};return a}(f);b.AjaxAppender=l;f=function(c){function a(b){c.call(this,b,a.prototype.sendLogItemsConsole)}__extends(a,c);a.prototype.clog=function(a){console.log(a)};a.prototype.cerror=function(a){console.error?console.error(a):this.clog(a)};a.prototype.cinfo=function(a){console.info?console.info(a):this.clog(a)};a.prototype.cwarn=
function(a){console.warn?console.warn(a):this.clog(a)};a.prototype.sendLogItemsConsole=function(a){try{if(console){var c;for(c=0;c<a.length;++c){var d=a[c],e=d.n+": "+d.m;d.l<=b.getDebugLevel()?this.clog(e):d.l<=b.getInfoLevel()?this.cinfo(e):d.l<=b.getWarnLevel()?this.cwarn(e):this.cerror(e)}}}catch(f){}};return a}(f);b.ConsoleAppender=f;f=function(){function b(a){this.loggerName=a;this.seenRegexes=[]}b.prototype.stringifyLogObject=function(a){switch(typeof a){case "string":return a;case "number":return a.toString();
case "boolean":return a.toString();case "undefined":return"undefined";case "function":return a instanceof RegExp?a.toString():this.stringifyLogObject(a());case "object":return a instanceof RegExp||a instanceof String||a instanceof Number||a instanceof Boolean?a.toString():JSON.stringify(a);default:return"unknown"}};b.prototype.setOptions=function(a){c("level",a,this);c("userAgentRegex",a,this);c("disallow",a,this);c("ipRegex",a,this);c("appenders",a,this);c("onceOnly",a,this);this.seenRegexes=[];
return this};b.prototype.log=function(a,b){var c=0,d;if(!this.appenders)return this;if(a>=this.level&&h(this)&&(d=this.stringifyLogObject(b),e(this,d))){if(this.onceOnly)for(c=this.onceOnly.length-1;0<=c;){if(RegExp(this.onceOnly[c]).test(d)){if(this.seenRegexes[c])return this;this.seenRegexes[c]=!0}c--}for(c=this.appenders.length-1;0<=c;)this.appenders[c].log(a,d,this.loggerName),c--}return this};b.prototype.trace=function(a){return this.log(1E3,a)};b.prototype.debug=function(a){return this.log(2E3,
a)};b.prototype.info=function(a){return this.log(3E3,a)};b.prototype.warn=function(a){return this.log(4E3,a)};b.prototype.error=function(a){return this.log(5E3,a)};b.prototype.fatal=function(a){return this.log(6E3,a)};return b}();b.Logger=f;f=new l("");b.__=new b.Logger("");b.__.setOptions({level:b.getDebugLevel(),appenders:[f]});b.createAjaxAppender=function(b){return new l(b)}})(JL||(JL={}));var exports;"undefined"!==typeof exports&&(exports.JL=JL);var define;
"function"==typeof define&&define.amd&&define(function(){return JL});
